...
torch.save(deploy_dict, './deploy_weight.pth.tar')
model = ScaleDense.ScaleDense(8, 5, deploy=True)
model.load_state_dict(torch.load('./deploy_weight.pth.tar'))

# model.load_state_dict(torch.load(
# os.path.join("/home/liuziyang/workspace/brain_age_prediction/code/TSAN-brain-age-estimation/pretrained_mdoel/ScaleDense/ScaleDense_best_model.pth.tar")
#                                 )['state_dict']) 
# state = torch.load("/home/liuziyang/workspace/brain_age_prediction/code/TSAN-brain-age-estimation/pretrained_mdoel/ScaleDense/ScaleDense_best_model.pth.tar")['state_dict']                    
# print(state)